...
<body class="b-theme">
    ...
    <a class="navbar-brand" href=""> <img class="logo" src="../imagens/logotipo.png"></a>
        ...
        <div class="collapse navbar-collapse col-lg-8 offset-lg-2" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../categorias/tecnologia.php">Tecnologia</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row">
        <img src="../imagens/tecnologia.jpg" class="principal-images offset-lg-2  mt-lg-4 mt-4 mt-4 col-12  col-lg-8 w-images" alt="imagem de tela com códigos de computador">
        <div class="col-lg-8 offset-lg-2 b-article mt-lg-5 w-article">
            <article class="h-article-lg w-article">
                <header>
                <div class="row justify-content-center">  

                <h1 class="c-yellow-letter-header ml-3">Tecno</h1>

                <h1 class="c-orange-letter-header">logia</h1>

                </div>
                </header>
                
                <p class="letter-article text-align-color-title-categories">
                Todos o jargões de nossa base sobre tecnologia de A-Z
