...
<body class="b-theme">
    ...
    <nav class="navbar navbar-expand-lg navbar navbar-light bg-light c-letter-nav ">
        <a class="navbar-brand" href="#">Jargon</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 offset-lg-2 b-article mt-lg-5 w-article">
            <article class="h-article-lg w-article">
                ...
                <h1 class="c-yellow-letter-header ml-3">Política d</h1>

                <h1 class="c-orange-letter-header">e privacidade</h1>

                </div>
                </header>
                
                <p class="letter-article text-align-color-title-categories">
                    A única informação de usuário guardada em nossos servidores
                    é quantidade de acessos por determinado ip
                    a fim de proteger a estabilidade do site.

                    Ao utilizar o site, você deve concordar plenamente com este termo.
