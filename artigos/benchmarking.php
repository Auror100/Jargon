...
<body class="b-theme">
    ...
    <div class="row">
        <img src="../imagens/benchmarking.jpg" class="principal-images offset-lg-2  mt-lg-4 mt-4 mt-4 col-12  col-lg-8 w-images" alt="imagem contendo uma cidade e em sua frente caminhões, aviões e um navio. No caso é apenas uma ilustração simbólica para a palavra, visto que imagem apresenta o significado de gerenciamento">
        <div class="col-lg-8 offset-lg-2 b-article mt-lg-5 w-article">
            <article class="h-article-lg w-article">
                <header>
                <div class="row">  

                <h1 class="c-yellow-letter-header ml-3">Bench</h1>

                <h1 class="c-orange-letter-header">marking</h1>

                </div>
                </header>
                <p class="letter-article">Processo de avaliação que uma empresa realiza 
                    em relação aos seus concorrentes.
                </p>

                <p class="letter-article">Realizado através de uma pesquisa detalhista,
                     possui objetivo de identificar os diferenciais
                     competitivos e as características das empresas
                     concorrentes de maneira que a empresa pesquisadora 
                     aperfeiçoe os seus próprios métodos e produtos. 
    ...
    <div class="footer-basic margin-footer w-footer">
        <footer class="margin-footer">
            <div class="social"><a href="#"><i class="icon ion-social-instagram"></i></a><a href="#">
                <a href="#"><i class="icon ion-social-twitter"></i></a><a href="#"><i class="icon ion-social-facebook"></i></a></div>
